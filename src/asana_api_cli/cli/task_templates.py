...
@formatted
def get_task_templates(offset: str | None, opt_fields: str | None, project: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_task_templates, opts=opts, max_items=max_items)
