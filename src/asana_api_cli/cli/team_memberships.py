...
@formatted
def get_team_memberships(workspace: str | None, limit: int | None, offset: str | None, opt_fields: str | None, team: str | None, user: str | None, no_workspace: bool, paginate: bool) -> Any:
