...
@click.group("time-tracking-categories", cls=GroupWithGlobalOptions)
...
@formatted
def get_time_tracking_categories(workspace: str | None, is_archived: bool | None, offset: str | None, opt_fields: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_time_tracking_categories, resolved_workspace, opts=opts, max_items=max_items)
...
@click.option("--max-items", "max_items", type=int, default=None, help="Stop after fetching this many items in total")
@formatted
def get_time_tracking_entries_for_time_tracking_category(time_tracking_category: str, end_date: str | None, offset: str | None, opt_fields: str | None, start_date: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_time_tracking_entries_for_time_tracking_category, time_tracking_category, opts=opts, max_items=max_items)
