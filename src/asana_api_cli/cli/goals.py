...
@formatted
def get_goals(workspace: str | None, is_workspace_level: bool | None, offset: str | None, opt_fields: str | None, portfolio: str | None, project: str | None, task: str | None, team: str | None, time_periods: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    """Get goals"""
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_goals, opts=opts, max_items=max_items)
