...
@formatted
def get_portfolio_memberships(workspace: str | None, offset: str | None, opt_fields: str | None, portfolio: str | None, user: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_portfolio_memberships, opts=opts, max_items=max_items)
...
@click.option("--max-items", "max_items", type=int, default=None, help="Stop after fetching this many items in total")
@formatted
def get_portfolio_memberships_for_portfolio(portfolio: str, offset: str | None, opt_fields: str | None, user: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if user is not None:
        opts["user"] = user
    if max_items is not None:
        return session.fetch_capped(api.get_portfolio_memberships_for_portfolio, portfolio, opts=opts, max_items=max_items)
