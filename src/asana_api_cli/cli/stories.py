...
@formatted
def get_stories_for_goal(goal: str, offset: str | None, opt_fields: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if max_items is not None:
        return session.fetch_capped(api.get_stories_for_goal, goal, opts=opts, max_items=max_items)
...
@click.option("--max-items", "max_items", type=int, default=None, help="Stop after fetching this many items in total")
@formatted
def get_stories_for_task(task: str, offset: str | None, opt_fields: str | None, all_items: bool, paginate: bool, page_size: int | None, max_items: int | None) -> Any:
    ...
    if opt_fields is not None:
        opts["opt_fields"] = opt_fields
    if max_items is not None:
        return session.fetch_capped(api.get_stories_for_task, task, opts=opts, max_items=max_items)
